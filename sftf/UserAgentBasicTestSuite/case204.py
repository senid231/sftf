...
class case204(TestCase):
    ...
    def run(self):
        ...
        to.uri.params.append(
            "unknownparam=verylonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglongvalue")
        to.uri.params.append(
            "longparamnamenamenamenamenamenamenamenamenamenamenamenamenamenamenamenamenamenamenamenamenamenamenamenamename=shortvalue")
        to.uri.params.append(
            "verylonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglongParameterNameWithNoValue")
        ...
        fo.uri.params.append(
            "unknownheaderparamnamenamenamenamenamenamenamenamenamenamenamenamenamenamenamenamenamenamenamename=unknownheaderparamvaluevaluevaluevaluevaluevaluevaluevaluevaluevaluevaluevaluevaluevaluevalue")
        fo.uri.params.append(
        ...
        inv.setHeaderValue(
            "Unknown-LongLongLongLongLongLongLongLongLongLongLongLongLongLongLongLongLongLongLongLong-Name",
        ...
        inv.rUri.params.append(
            "verylonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglongparameter=verylonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglonglongvalue")
