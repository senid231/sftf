    ...
    def run(self):
        ...
        if self.ack is not None:
            ...
            if self.inv.rUri != self.ack.rUri:
                Log.logDebug("case601ack: INVITE uri (\'" + str(self.inv.rUri.create()) + "\') and ACK uri (\'" + str(
                    self.ack.rUri.create()) + "\') differ", 1)
                ...
                Log.logDebug("case601ack: INVITE topmost Via (\'" + str(req_via) + "\') and ACK topmost Via (\'" + str(
                    can_via) + "\') differ", 1)
                ...
                Log.logDebug("case601ack: To tag in ACK (\'" + str(
                    ack_to.tag) + "\') differes from tag in reply (\'" + self.testtag + "\')", 1)
